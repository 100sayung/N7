...
<body>
	...
	<br>
      ...
      <br><br>
<<<<<<< HEAD
      <div style="width: 1280px; background-color: #3D6B9B; color: white; padding: 1%;">반품관리</div>
               <select id="choice">
=======
...
>>>>>>> master
      ...
      <form id="o_return">
<<<<<<< HEAD
         <div style="height: 80px; padding-top: 25px; background-color: #F8F7F7; width:1280px;">
